    ...
    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
        <div class="card mb-3">
			<div class="card-body">
              	...
              	<form  class="row g-3 needs-validation" novalidate method="post" action="#" name="bform">
				  	<?if ($arResult["BACKURL"] <> ''): ?>
					...
					<label class="form-label"><?=GetMessage("AUTH_LOGIN")?></label>
						<div class="input-group has-validation">
							...
							<div class="invalid-feedback"><?=GetMessage("AUTH_REQ_LOGIN")?></div>
						</div>
					</div>
					...
					<label class="form-label"><?=GetMessage("AUTH_CHECKWORD")?></label>
						<div class="input-group has-validation">
							...
							<div class="invalid-feedback"><?=GetMessage("AUTH_REQ_CHECKWORD")?></div>
						</div>
					</div>
					...
					<div class="input-group has-validation">
						...
						<div class="invalid-feedback"><?=GetMessage("AUTH_REQ_NEW_PASSWRD")?></div>
					</div>
					</div>
					<div class="col-12">
					...
					<div class="input-group has-validation">
						...
						<div class="invalid-feedback"><?=GetMessage("AUTH_REQ_CONFIRM_PASSWRD")?></div>
					</div>
					</div>

					<!-- IF USED CAPTCHA -->
					<div class="col-12">
						<label class="form-label"><?=GetMessage("system_auth_captcha")?>
						</label>
						<div class="input-group has-validation">
