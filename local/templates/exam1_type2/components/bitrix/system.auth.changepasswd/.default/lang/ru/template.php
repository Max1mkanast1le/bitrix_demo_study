...
$MESS ['AUTH_REQ_LOGIN'] = "Заполните логин";
$MESS ['AUTH_REQ_CHECKWORD'] = "Заполните контрольную строку";
$MESS ['AUTH_REQ_NEW_PASSWRD'] = "Заполните новый пароль";
$MESS ['AUTH_REQ_CONFIRM_PASSWRD'] = "Заполните подтверждение пароль";
