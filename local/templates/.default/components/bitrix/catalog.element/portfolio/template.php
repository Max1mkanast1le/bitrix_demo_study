  ...
  <div class="row gy-4">
	...
	<div class="col-lg-4">
	  <div class="portfolio-info">
		<h3><?=GetMessage("CT_BCE_PROJECT")?></h3>
		<ul>
		  <li><strong><?=GetMessage("CT_BCE_SERVICES")?></strong>: <?=$arResult["SECTION"]["NAME"]?></li>
			   <li><strong><?=GetMessage("CT_BCE_BUSINESS_SECTOR")?></strong>: <?=$arResult["PROPERTIES"]["BUSINESS_SECTOR"]["VALUE"]?></li>
		  <li><strong><?=GetMessage("CT_BCE_COMPANY")?></strong>: <?=$arResult["PROPERTIES"]["CLIENT_NAME"]["VALUE"]?></li>
		</ul>
	  </div>
	  ...
	  <div>
		<a href="/portfolio/"><b>В список</b></a>
	  </div>
